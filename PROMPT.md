...
This prompt is optimized to produce a **v1.0.0 compliant** specification that integrates with `AGENTS.md` and other standard protocols.
...
```markdown
Act as an expert AI Agent Architect. I need you to generate a valid `employee.md` file (v1.0.0 standard) for a new AI agent.
