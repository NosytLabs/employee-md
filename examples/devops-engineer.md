...
integration:
  apis:
    - name: "aws-api"
      ...
      auth_type: "api_key"  # AWS uses SigV4; closest schema-compliant value
      rate_limit: 1000
  ...
  services:
    # Note: the Kubernetes cluster is exposed via the kubernetes-mcp server below.
    # The 'services' block here only enumerates services matching the schema enum
    ...
    - name: "deployment-events"
      type: "queue"
      connection_string: "${DEPLOYMENT_QUEUE_URL}"
